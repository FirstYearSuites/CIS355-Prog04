...
class fileUploader{
    ...
    function upload01(string $fileName, string $tempFileName, string $fileLocation){
        ...
        if(!file_exists($filePath)){
            ...
            echo "File <b><i>" . $fileName . "</i></b> already exists. Please rename file.";
        }
    }

    function upload02(string $fileName, string $tempFileName, int $fileSize, string $fileType, string $fileLocation, string $fileDescription){
        ...
        function upload03(string $fileName, string $tempFileName, int $fileSize, string $fileType, string $fileLocation, string $fileDescription){
